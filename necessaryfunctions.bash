...
_CALLSYSTEM_() {
	...
	then
		_GETIMAGE_ || FRV="$?" && [[ -z "${FRV:-}" ]] && _PSGI1ESTRING_ "_GETIMAGE_ _CALLSYSTEM_ necessaryfunctions.bash ${0##}" && exit || ([[ $FRV = 3 ]] || [[ $FRV = 22 ]]) && _PSGI1ESTRING_ "FRV=$FRV _GETIMAGE_ _CALLSYSTEM_ necessaryfunctions.bash ${0##}"
	else
