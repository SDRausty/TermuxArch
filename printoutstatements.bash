...
_PRINTFOOTER2_() {
	...
	[[ "$CPUABI" = "$CPUABIX86_64" ]] && printf "\\e[1;34m%s\\e[0m\\n\\n" "The website https://bbs.archlinux.org/ has Arch Linux discussion forums.  The webpage https://wiki.archlinux.org/index.php/IRC_channel lists available Arch Linux IRC channels." || _PRTARFO_
}
