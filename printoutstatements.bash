...
FLHDR1[5]="VERSIONID=2.0.481"
FLHDR1[6]=""
FLHDRP[0]="## BEGIN #####################################################################"
FLHDRP[1]=""
TRPERROR[0]="_TRPERR_() {  # run on script error"
TRPERROR[1]="	local RV=\"\$?\""
TRPERROR[2]="	printf \"\\\\e[?25h\\\\n\\\\e[1;48;5;138m %s\\\\e[0m\\\\n\\\\n\" \"ＴｅｒｍｕｘＡｒｃｈ FEEDBACK:  Generated script signal \${RV:-UNKNOWN} near or at line number \${1:-UNKNOWN} by '\${2:-UNKNOWNCOMMAND}'!\""
TRPERROR[3]="	exit 201"
TRPERROR[4]="}"
TRPERROR[5]=""
TRPEXIT[0]=""
...
TRPEXIT[4]="	if [[ \"\$RV\" = 0 ]]"
TRPEXIT[5]="	then"
TRPEXIT[6]="		printf \"\\\\e[0;32m%s\\\\e[1;32m%s\\\\e[0;32m%s\\\\e[1;34m: \\\\e[1;32m%s\\\\e[0m\\\\n\\\\e[0m\" \"Command \" \"\${0##*/} \$ARGS\" \" version \$VERSIONID\" \"DONE 🏁 \""
TRPEXIT[7]="		printf \"\\\\e]2; %s: %s \007\" \"\${0##*/} \$ARGS\" \"DONE 🏁 \""
TRPEXIT[8]="	else"
TRPEXIT[9]="		printf \"\\\\e[0;32m%s\\\\e[1;32m%s\\\\e[0;32m%s \\\\e[0m%s\\\\e[1;34m: \\\\e[1;32m%s\\\\e[0m\\\\n\\\\e[0m\" \"Command \" \"\${0##*/} \$ARGS\" \" version \$VERSIONID\" \"[Exit Signal \$RV]\" \"DONE  🏁 \""
...
TRPSIGNAL[1]="	printf \"\\\\e[?25h\\\\e[1;7;38;5;0mＴｅｒｍｕｘＡｒｃｈ FEEDBACK:  Signal %s received!\\\\e[0m\\\\n\" \"\$?\""
TRPSIGNAL[2]="	exit 211"
TRPSIGNAL[3]="}"
TRPSIGNAL[4]=""
TRPQUIT[0]="_TRPQ_() {  # run on quit"
TRPQUIT[1]="	printf \"\\\\e[?25h\\\\e[1;7;38;5;0mＴｅｒｍｕｘＡｒｃｈ FEEDBACK:  Quit signal %s received!\\\\e[0m\\\\n\" \"\$?\""
TRPQUIT[2]="	exit 221"
TRPQUIT[3]="}"
TRPQUIT[4]="ARGS=\"\$*\""
