...
sysinfo ()
{
	...
	du -hs $HOME/arch >> setupTermuxArchdebug$ntime.log 2>/dev/null ||:
	printf "\nls -al $HOME/arch results:\n\n" >> setupTermuxArchdebug$ntime.log
	ls -al $HOME/arch >> setupTermuxArchdebug$ntime.log 2>/dev/null ||:
	printf "\nuname -a results:\n\n" >> setupTermuxArchdebug$ntime.log
	uname -a >> setupTermuxArchdebug$ntime.log
