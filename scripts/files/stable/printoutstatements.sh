...
printconfigq ()
{
	printf "\n\033[36;1m 🕙 < 🕛 \033[1;34mArch Linux in Termux is installed! Please answer the following questions to complete the Arch Linux configuration.  \n\n\033[0m"'\033]2; 🕙 < 🕛 Arch Linux in Termux is installed! Please complete the Arch Linux configuration.  📲  \007'
}
...
printfooter ()
{
	...
	copybin2path
	printf "\033[1;32m 🕛 = 🕛 \033[1;34mTermux-wake-lock released.  Arch Linux in Termux is installed.  \033[32;1m\`tzselect\`\033[1;34m wilk assit in setting the local time zone.  See https://github.com/sdrausty/TermuxArch/issues/25 \"Starting Arch Linux from Termux?\" for information.  \n\n\033[0m"
}
