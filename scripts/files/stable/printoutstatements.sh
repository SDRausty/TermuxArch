...
printfooter ()
{
	...
	copybin2path
	printf "\033[1;32m 🕛 = 🕛 \033[1;34mTermux-wake-lock released.  Your Arch Linux in Termux is installed.  \033[32;1m\`tzselect\`\033[1;34m wilk assit in setting the local time zone.  See https://github.com/sdrausty/TermuxArch/issues/25 \"Starting Arch Linux from Termux?\" for information.  \n\n\033[0m"
}
