...
{
	printf "\033[1;34mDownloading \033[0;32m$file \033[1;34mfrom geographically nearby mirror \033[0;32m$nmirror\033[1;34m…  \033[1;37mThis may take a long time pending Internet connection.  \033[1;34mIf the geographically nearby mirror is unresponsive, run \033[0;32mbash setupTermuxArch.sh\033[1;34m again.  Should the worldwide mirror \033[0;32m$nmirror\033[1;34mnot hand off a new geographically nearby server after a few attempts, use \033[0;32mbash setupTermuxArch.sh --manual\033[1;34m.  See \033[0;32mbash setupTermuxArch.sh --help \033[34;1mfor additional information.\n\n\033[0;32m"
}
...
printmd5success ()
{
	printf '\033]2;  🕛 > 🕡 Uncompressing the image file.  This will take a long time; Be patient.\007'"\033[1;34m 🕛 > 🕕 \033[1;34mSystem image file download integrity: \033[32;1mOK\n\n\033[1;34m 🕛 > 🕡 \033[1;34mUncompressing \033[32;1m$file\033[1;34m.  \033[1;37mThis will take a long time; Be patient.\n\033[0m"
}
...
printfooter ()
{
	printf "\n\033[1;34m 🕛 > 🕥 \033[1;34mUse \033[1;32m.$rootdir/$bin\033[1;34m from the \033[1;32m\$HOME\033[1;34m directory to launch Arch Linux in Termux for future sessions.   Alternatively copy \033[1;32m$bin\033[1;34m to the \033[32m\$PATH\033[1;34m which is, \033[37m\"$PATH\"\033[0m.\n\n"'\033]2;  Thank you for using `setupTermuxArch.sh` to install Arch Linux in Termux 📲  \007'
	copybin2path
	...
	printf "\nArch Linux is installed in $HOME$rootdir\n" 
}
