...
aarch64 ()
{
	...
	mirror=ca.us.mirror.archlinuxarm.org
	path=/os/
	makesystem 
}
...
i686 ()
{
	# i686 is frozen at release 2017.03.01-i686. See https://www.archlinux.org/news/phasing-out-i686-support/ for more information.  Inquire https://archlinux32.org/ for updates.   
