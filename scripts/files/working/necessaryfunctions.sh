...
runfinishsetup ()
{
	...
	while true; do
		printf "\n\033[0;34mWhen \033[1;34mgpg: Generating pacman keyring master key\033[0;34m appears on the screen, the installation process can be accelerated.  The system desires a lot of entropy at this stage of the install procedure.  To generate as much entropy as possible quickly, watch and listen to a file from a file manager on your device.  To generate entropy, we want randomness.  \n\nThe programs \033[1;34mpacman\033[0;34m and \033[1;34mpacman-key\033[0;34m will want as much as possible when employing keys.  Entropy is also created through tapping, sliding, two and more fingers tapping and long taps…  This method might not generate enough entropy for the process to complete quickly.  When \033[1;34mgpg: Generating pacman keyring master key\033[0;34m appears on the screen, use any of these simple methods to accelerate the installation process if it is stalled.  Put even simpler, just do something on device.  Browsing files in a file manager is an example of generating entropy.\n\n\033[0;32mOne final question before updating, would you like to run \033[1;32mlocale-gen\033[0;32m to generate the en_US.UTF-8 locale, or edit \033[1;32m/etc/locale.gen\033[0;32m specifying your preferred language(s) before running \033[1;32mlocale-gen\033[0;32m?  "
