...
{
	printf "\033[0;34m 🕛 > 🕓 \033[1;34mDownloading the checksum file and \033[1;34m$file \033[1;34mfrom the geographically local mirror \033[1;32m$nmirror\033[1;34m.  If contact with the local mirror is not successful, run \033[1;32mbash \033[0;32msetupTermuxArch.sh\033[1;34m again.  Should the worldwide mirror not provide another geographically nearby server after a couple of attempts, use \033[0;32msetupTermuxArch.sh --manual \033[1;34mafter locating a local mirror from the Internet; See \033[0;32msetupTermuxArch.sh --help \033[1;34mfor additional options.\n\nRemember the local mirror address, \033[1;32m$nmirror\033[1;34m pending success of this download.  This \033[0;36mIMPORTANT \033[1;34minformation is wanted for the mirrorlist file later during the the installation process.  \033[1;37mDownload of $file pending Internet connection:\n\n\033[0;32m"'\033]2; 🕛 > 🕓 Downloading the checksum and Arch Linux system image file…  \007'
}
...
printfooter ()
{
	...
	copybin2path
	printf "\033[0;32m 🕛 = 🕛 \033[1;34mAdd the \033[1;32mtzselect\033[1;34m output code to \033[1;32m.bash_profile\033[1;34m so the system time in Arch Linux for future sessions will be set correctly.  Information about \033[0;36mStarting Arch Linux from Termux?\033[1;34m at \033[1;34mhttps://github.com/sdrausty/TermuxArch/issues/25\033[1;34m.  Arch Linux in Termux PRoot is installed in $HOME$rootdir.  Use \033[1;32mtour\033[1;34m to run a short tour, and get to know your new environment better.  This project is in active development and contributions are encouraged; See https://sdrausty.github.io/TermuxArch/CONTRIBUTORS for information.  The documtation repository for TermuxArch https://sdrausty.github.io/TermuxArch/docs/ is at https://github.com/sdrausty/docsTermuxArch.  Pull requests and contributions through the issues pages are encouraged.  Use \033[1;32m.$rootdir/$bin\033[1;34m from the \033[1;32m\$HOME\033[1;34m directory or \033[1;32m$bin\033[1;34m if copied to \$PATH to launch Arch Linux in Termux for future sessions.  \n\n\033[0m"
}
