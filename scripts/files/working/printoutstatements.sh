...
spaceMessageWarning ()
{
	spaceMessage="\033[1;33m\nTermuxArch: WARNING!  \033[36mStart thinking about cleaning out some stuff.  The user space on \033[1;33mthis device has just $usrspace free space.  \033[32mThe recommended minimum to install Arch Linux in Termux PRoot is more than 1G of free user space in \033[1;32m\$HOME\033[32m.\n\033[0m"
}
