...
spaceMessageWarning ()
{
	spaceMessage="\033[1;31m\nTernuxArch: WARNING!  Start thinking about cleaning out some stuff.  The user space on this device has just $usrspace.  This is less than the recommended minimum to install Arch Linux in Termux PRoot.  More than 1G of free user space in \`\$HOME\` is suggested in order to enjoy the user experience.\n\n\033[0m"
}
