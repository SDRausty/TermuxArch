...
printfooter () {
	printf "\033[0;34m 🕛 > 🕥 \033[1;34mUse \033[1;32m$startbin\033[1;34m to launch Arch Linux in Termux PRoot.  Alternatively, run \033[1;32m~$printrootdir/$startbin \033[1;34min a BASH shell to start Arch Linux in Termux PRoot for future sessions also.  Use the TermuxArch command \033[1;32mkeys \033[1;34mto install and generate Arch Linux keyring keys.\033[0m\n\n"'\033]2;  Thank you for using `setupTermuxArch.sh` to install Arch Linux in Termux 📲  \007'
	copystartbin2path
