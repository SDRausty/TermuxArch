...
printconfigq ()
{
	printf "\033[0;34m 🕛 > 🕤 \033[1;34mArch Linux in Termux PRoot is installed.  Answer the following questions to complete the Arch Linux configuration:\n\033[0m"'\033]2; 🕛 > 🕙 Arch Linux is installed!  Configure and update Arch Linux 📲 \007'
}
...
printfooter ()
{
	...
	copybin2path
	printf "\033[0;32m 🕛 = 🕛 \033[1;34mTermux-wake-lock released.  Use \033[1;32mtzselect\033[1;34m to set the local time zone if you haven't.  Remember to add the \033[1;32mtzselect\033[1;34m output code to your \033[1;32m.profile\033[1;34m file to set up the time in Arch Linux for future sessions.  More information about, \033[0;34m\"Starting Arch Linux from Termux?\"\033[1;34m at https://github.com/sdrausty/TermuxArch/issues/25.  \033[0;32mArch Linux is installed in $HOME$rootdir\n\n\033[0m"
}
