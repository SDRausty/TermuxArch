...
# 	printf "\\a\\n\\e[0;32mi%s %s \\a\\e[0m$versionid \\e[1;34m: \\a\\e[1;32mDONE\\e[0m 🏁  \\n\\n\\a\\e[0m" "$(echo $0)" "$@" '\033]2;  setupTermuxArch.sh '"$@"' : DONE 🏁 \007'
	printf "\\a\\n\\e[0;32m%s %s \\a\\e[0m$versionid \\e[1;34m: \\a\\e[1;32mDONE\\e[0m 🏁  \\n\\n\\a\\e[0m" "$(echo $0)" "$@"
	printf '\033]2;  setupTermuxArch.sh '"$@"' : DONE 🏁 \007'
}
...
trap finisher ERR
trap finishe EXIT
versionid="gen.v1.6 id071050854041"
