...
introbloom ()
{
	printf '\033]2;  Thank you for using `bash setupTermuxArch.sh` 📲 \007'
	spaceinfo
	printf "\n\033[36;1m 🕛 < 🕛 \033[1;34mTermuxArch will create.  Ensure background data is not restricted.  If you do not see one o'clock 🕐 below, check the wireless connection.  Run \033[36mbash setupTermuxArch.sh --help \033[34;1mfor additional information.  "
}
