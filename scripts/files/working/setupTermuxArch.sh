...
introbloom ()
{
	...
	spaceinfo
	printf "\n\033[36;1m 🕛 < 🕛 \033[1;34mTermuxArch bloom option.  Run \033[36mbash setupTermuxArch.sh --help \033[34;1mfor additional information.  Ensure background data is not restricted.  Check the wireless connection if you do not see one o'clock 🕐 below.  "
}
...
introdebug ()
{
	printf '\033]2;  Thank you for using `bash setupTermuxArch.sh` 📲 \007'
	spaceinfo
	printf "\n\033[36;1m 🕛 < 🕛 \033[1;34mTermuxArch will create a system information file.  Ensure background data is not restricted.  Run \033[36mbash setupTermuxArch.sh --help \033[34;1mfor additional information.  Check the wireless connection if you do not see one o'clock 🕐 below.  "
	dependsblock 
}
