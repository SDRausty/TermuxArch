...
depends ()
{
	printf '\033]2;  Thank you for using `setupTermuxArch.sh` 📲 \007'"\n 🕛 \033[36;1m< 🕛 \033[1;34mTermuxArch "
		printf "v0.6.1 id753773207"
	printf " will attempt to install Linux in Termux.  Arch Linux will be available upon successful completion.  If you do not see one o'clock 🕐 below, check the wireless connection.  Ensure background data is not restricted.  \033[34mbash ~/setupTermuxArch.sh --help \033[36;1mhas additional information.\n"
	predepends 
