...
bloom ()
{
	...
	printf "\033[1;34mTermuxArch Bloom Option via \033[1;32msetupTermuxArch.sh\033[0m  📲 \n\n\033[0m"'\033]2;  Thank you for using TermuxArch Bloom Option via setupTermuxArch.sh 📲 \007'
	ls -al
	printf "\n"
	pwd
	dependsblock 
	printf "\n\033[1;34mTermuxArch Bloom Option via \033[1;32msetupTermuxArch.sh\033[0m  📲 \n\n\033[0m"'\033]2;  Thank you for using TermuxArch Bloom Option via setupTermuxArch.sh 📲 \007'
	ls -al
	edq
	$ed necessaryfunctions.sh setupTermuxArch.sh file.tmp
}
