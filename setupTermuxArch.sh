...
depends ()
{
	printf '\033]2;  Thank you for using `setupTermuxArch.sh` 📲 \007'"\n 🕛 \033[36;1m< 🕛 \033[1;34mThis script will attempt to install Arch Linux in Termux.  When successfully completed, Arch Linux will be available.  "
	print1clk 
