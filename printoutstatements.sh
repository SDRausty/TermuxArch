...
FLHDR1[5]="VERSIONID=v1.6.4.id1484"
FLHDR1[6]=" "
FLHDRP[0]="## BEGIN #######################################################################"
FLHDRP[1]=""
...
_PRINTWLA_() {
	printf "\033[0;34m 🕛 > 🕒 \033[1;34mActivating wake-lock: "'\033]2; 🕛 > 🕒 Activating wake-lock: OK\007'
}

_PRINTWLD_() {
	printf "\n\033[0;34m 🕛 > 🕙 \033[1;34mReleasing wake-lock: "'\033]2; 🕛 > 🕙 Releasing wake-lock: OK\007'
}
