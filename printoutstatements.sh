...
FLHDR1[5]="VERSIONID=v1.6.2.id1891"
FLHDR1[6]=" "
FLHDRP[0]="## BEGIN #######################################################################"
FLHDRP[1]=""
